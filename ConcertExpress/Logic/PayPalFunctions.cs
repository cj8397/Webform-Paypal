...
public class NVPAPICaller
{
    ...
    public string APIUsername = "seller_api1.cheng.com";
    private string APIPassword = "2Y8QHBAFJSZYMJBM";
    private string APISignature = "AYe3Tc3Ls-P2oatmpeD8iqYQQS8BAW2adyA6zOLnS7PgQuAg-mj5IP1l";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        string returnURL = "https://localhost:49919/Checkout/CheckoutReview.aspx";
        string cancelURL = "https://localhost:49919/Checkout/CheckoutCancel.aspx";

        //string returnURL = "https://paypaldemo.agile-c.com/Checkout/CheckoutReview.aspx";
        //string cancelURL = "https://paypaldemo.agile-c.com/Checkout/CheckoutCancel.aspx";

        NVPCodec encoder = new NVPCodec();
        encoder["METHOD"] = "SetExpressCheckout";
        encoder["RETURNURL"] = returnURL;
        encoder["CANCELURL"] = cancelURL;
        encoder["BRANDNAME"] = "ConcertExpress";
        ...
        using(ConcertExpress.Logic.ShoppingCartActions myCartOrders = new ConcertExpress.Logic.ShoppingCartActions())
        {
